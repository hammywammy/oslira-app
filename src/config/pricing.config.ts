...
export const PRICING_TIERS: Record<TierName, PricingTier> = {
  free: {
    ...
    description: 'Test the platform and validate your process',
    ctaText: 'Start Free',
  },
  ...
  growth: {
    ...
    description: 'Solo operators and consultants building pipeline',
  ...
  pro: {
    ...
    description: 'Founder-led sales and small teams at scale',
    highlighted: true,
    badge: 'Most Popular',
    ctaText: 'Start Pro',
  },
  ...
  agency: {
    ...
    description: 'Agencies and sales teams managing multiple pipelines',
  ...
  enterprise: {
    ...
    description: 'Enterprise organizations requiring custom solutions',
    badge: 'Premium',
